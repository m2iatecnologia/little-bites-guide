...
export default function Auth() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      if (isCustomDomain) {
        // On custom domains, bypass auth-bridge and handle redirect manually
        ...
        // On Lovable domains, use managed auth
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6" style={{ background: "hsl(var(--app-cream))" }}>
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              required
              minLength={6}
              className="w-full py-3.5 pl-11 pr-11 rounded-2xl text-sm"
              style={{ background: "hsl(var(--app-card))", border: "1.5px solid hsl(var(--app-divider))", color: "hsl(var(--app-petrol))" }} />
